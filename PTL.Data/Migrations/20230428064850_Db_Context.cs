    ...
    public partial class Db_Context : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Regoins", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Provinces_Regoins_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regoins",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RegionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UnsignedName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdministrativeUnits_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdministrativeUnits_Provinces_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "Provinces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdministrativeUnits_Regoins_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regoins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdministrativeUnits_Villages_VillageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvinceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AdministrativeUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PermanentPlace = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Gender = table.Column<int>(type: "int", nullable: true),
                    EthnicId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Religion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumberIdentityCard = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IssuedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Department = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WorkUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    NumberYearOfEx = table.Column<int>(type: "int", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ImageContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Extang = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GraduationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Staffs_AdministrativeUnits_AdministrativeUnitId",
                        column: x => x.AdministrativeUnitId,
                        principalTable: "AdministrativeUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Staffs_AppUser_EditorId",
                        column: x => x.EditorId,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Staffs_Ethnics_EthnicId",
                        column: x => x.EthnicId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Staffs_Graduations_GraduationId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Staffs_WorkUnits_WorkUnitId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "e57f94d9-35be-4d37-b7d0-6ef34f6249ce", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "Phamlong2292@gmail.com", true, "Long", "Pham", false, null, "Phamlong2292@gmail.com", "admin", "AQAAAAIAAYagAAAAEKdXhYMHn2DNpiEabByWfRh/eo45D3MFzSmD1ec0JWahxTnApW+VaQq2TFA3mQROSQ==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 4, 28, 13, 48, 50, 566, DateTimeKind.Local).AddTicks(5928), null, 100000m, 200000m });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdministrativeUnits_DistrictId",
                table: "AdministrativeUnits",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_AdministrativeUnits_ProvinceId",
                table: "AdministrativeUnits",
                column: "ProvinceId");

            migrationBuilder.CreateIndex(
                name: "IX_AdministrativeUnits_RegionId",
                table: "AdministrativeUnits",
                column: "RegionId");

            migrationBuilder.CreateIndex(
                name: "IX_AdministrativeUnits_VillageId",
                table: "AdministrativeUnits",
                column: "VillageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Staffs_AdministrativeUnitId",
                table: "Staffs",
                column: "AdministrativeUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Staffs_EditorId",
                table: "Staffs",
                column: "EditorId");

            migrationBuilder.CreateIndex(
                name: "IX_Staffs_EthnicId",
                table: "Staffs",
                column: "EthnicId");
