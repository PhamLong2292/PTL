...
namespace PTL.Services.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new PTLException($"Cannot find a product: {productId}");
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            if (image == null)
                throw new PTLException($"Cannot find an image with id {imageId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new PTLException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new PTLException($"Cannot find a product with id: {productId}");
